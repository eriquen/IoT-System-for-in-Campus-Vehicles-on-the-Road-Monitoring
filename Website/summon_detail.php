...
<main class="grey lighten-4">
    <div class="container">
    <div class=" white lighten-4 mt-50">
                <div class="white lighten-4 p-2">
                <div class="row n-m">
                    <div>
                        <div class="col l4">
                            <div class="logo_u">
                                <img class="logo" src="admin/images/logo/unimap_logo.png">
                ...
                <div class="row n-p-t">
                    <div class="col l8">
                        <ul>
                            ...
                            <li>IC NO/PASSPORT NO:&ensp;&ensp;&ensp;<?php echo $summon->ic_num ?></li>
                ...
                <div class="row">
                    ...
                    <div class="col l10">
                        <img class="vehicle_image"  src="<?php echo $summon->picture_path_from_user(); ?>" alt="">
                    </div>
                    <div class="col l1"></div>
